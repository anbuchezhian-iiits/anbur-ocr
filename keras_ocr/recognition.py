...
def build_model(
    ...
    # Spatial Transformer Network (STN) (if enabled)
    if stn:
        ...
        # Updated dense layer with kernel_initializer
    ...
    # Dropout and final Dense layer for character prediction
    ...
    # Prediction model (decoding output using CTC)
